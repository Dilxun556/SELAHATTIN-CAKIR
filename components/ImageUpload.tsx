...
const ImageUpload: React.FC<ImageUploadProps> = ({ label, onFileChange, id }) => {
    ...
    <div className="mb-6">
      ...
      <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md bg-white">
        <div className="space-y-1 text-center">
          {previewUrl ? (
            <img src={previewUrl} alt="Preview" className="mx-auto h-48 w-auto object-contain rounded-md mb-4" />
          ) : (
            <svg
